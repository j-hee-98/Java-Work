...
*/
	void methodExam03(int th) {
		
		System.out.println("인수로 받은 정수 : "+ th);
		
		if (th % 2 == 0) System.out.println("짝수");
...
*/
	protected String methodExam04(int st) {
		
		System.out.println("인수로 받은 정수 : "+st);
